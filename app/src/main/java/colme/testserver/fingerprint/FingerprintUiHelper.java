...
/**
 * Small helper class to manage text/icon around colme.testserver.fingerprint authentication UI.
 */
public class FingerprintUiHelper extends FingerprintManager.AuthenticationCallback {
    private static final Logger LOG = Logger.getLogger(FingerprintManager.class.getName());
    ...
    public void onAuthenticationError(int errMsgId, CharSequence errString) {
        if (!mSelfCancelled) {
            LOG.info("ERROR " + errString + " - codigo - " + errMsgId);
            showError(errString);
